...
| [LimaCharlie](https://limacharlie.io) | SecOps Cloud Platform — API-first, infrastructure-as-code security building blocks (EDR, telemetry, detection/response, multi-tenant) with agentic AI operators, MSSP-focused | cloud, hybrid | $3/endpoint/mo + $0.20/GB ingested/stored, pay-as-you-go (verified 2026-07) | B |
