...
### Lit review (~/security-data-literature-review)
Rulings ratified — see `STAGED-litreview-oxford-readiness-2026-07-12.md`. Phase 2B: living-review identity with paper/ export; machine-derived claim-count gate; RETRO-RUN systematic search (protocol → run → reconcile → honest PRISMA, disclosed as retrospective); methods/scoring-rubric.md then Fig4/Table2 rescore (Fig5 falls out of it); Research-Integrity section after DR-5. Acks courtesy-only; paced behind the book.
