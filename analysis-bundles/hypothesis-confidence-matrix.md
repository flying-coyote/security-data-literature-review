...
> **2026-07-16 note (rescore edit 17):** `methods/scoring-rubric.md` is now the instrument of record for these scores, and the 2026-07-11 recompute to 17/25 used off-anchor dimension values, so it is superseded by the anchor-only recompute of 19/25 in `methods/RESCORE-2026-07-13.md` (ruled score canon 2026-07-16). The 17/25 stays in the body as the dated record of the interim recompute.
