...
**Master Database**: `/home/jerem/security-data-literature-review/vendor-landscape/vendor-database.json`
- 71 vendors
- 79 vendor-level evidence sources
- 84% Tier A quality (corrected evidence_summary metadata)

**MCP Server Database**: `/home/jerem/security-architect-mcp-server/data/vendor_database.json`
...
**Sync Script**: `/home/jerem/security-architect-mcp-server/scripts/sync_from_literature_review.py`
...
**Weekly Refresh**: `/home/jerem/security-architect-mcp-server/scripts/weekly_vendor_refresh.py`
- Validates analyst URLs (Gartner MQ, Forrester Wave)
- Checks for new publications
- Updates timestamps
- Auto-syncs to MCP server

**Monthly GitHub Metrics**: `/home/jerem/security-architect-mcp-server/scripts/github_metrics_tracker.py`
...
**Quality Review**: `/home/jerem/security-architect-mcp-server/docs/QUALITY-REVIEW-FINAL-SESSION-2.md`
...
**Session Archive**: `/home/jerem/security-architect-mcp-server/docs/SESSION-2025-10-23-SESSION-2-VENDOR-EXPANSION.md`
...
**Integration Recommendations**: `/home/jerem/security-architect-mcp-server/docs/LITERATURE-REVIEW-UPDATE-RECOMMENDATIONS.md`
