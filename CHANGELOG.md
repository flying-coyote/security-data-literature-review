...
- **Left flagged, not edited**: Trino Definitive Guide print-vs-digital ISBN (O'Reilly 403s even in a browser — manual check); mitreattack/ocsf Slack invite paths (no public invite link verified — do not invent).
