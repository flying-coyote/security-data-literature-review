...
- **187 sources catalogued** (185 tiered + 2 documented stubs; 41.6% Evidence Level A, live 2026-07-10 — 77/185; honest post-audit baseline + 2026 Tier-A primary sources + Tier-B bridge-framing + detection-engineering anchors + WT-2 production anchors; freshness sweep substantially complete — see RESEARCH-JOURNAL.md)
...
1. **MASTER-BIBLIOGRAPHY.md** - Complete bibliography with 187 catalogued sources (185 tiered), 41.6% Evidence Level A (live, 77/185)
...
- Evidence Level B: 90 of 185 · Evidence Level C: 18 of 185 (across 187 `#### ` blocks incl. 2 documented stubs)
