...
**Date**: 2026-08-05
**Source**: `MASTER-BIBLIOGRAPHY.md` (267 unique URLs extracted)
...
| Class | Count | Meaning |
|---|---|---|
| OK | 245 | 2xx/3xx — reachable |
| PAYWALL_OR_BLOCKED | 17 | 401/403/429 — expected for Gartner/IDC/Forrester-class sources, not a failure |
| DEAD | 2 | 404/410 — confirmed gone |
| ERROR | 3 | timeout/DNS/other, or a status code outside the three classes above |
| **Total** | **267** | |
...
| https://www.dataversity.net/the-data-centric-revolution-incremental-stealth-legacy-modernization/29181 | DEAD | 404 |  |
...
| https://web.archive.org/web/20250122143448/https://www.databricks.com/resources/ebook/state-of-data-ai | ERROR | 498 | unclassified HTTP status 498 |
...
| https://doi.org/10.1051/epjconf/202429501032 | PAYWALL_OR_BLOCKED | 403 | expected for paywalled/anti-bot sources; redirected -> https://www.epj-conferences.org/10.1051/epjconf/202429501032 |
